...
@RestController
@RequestMapping("/api/jhipster-sample-angular-application-kafka")
public class JhipsterSampleAngularApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleAngularApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleAngularApplicationKafkaResource(KafkaProperties kafkaProperties) {
