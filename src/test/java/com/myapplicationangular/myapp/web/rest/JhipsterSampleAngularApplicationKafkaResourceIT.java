...
import com.myapplicationangular.myapp.config.KafkaProperties;
...
class JhipsterSampleAngularApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleAngularApplicationKafkaResource kafkaResource = new JhipsterSampleAngularApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/jhipster-sample-angular-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/jhipster-sample-angular-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
